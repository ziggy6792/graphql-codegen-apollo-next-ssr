...
export async function getServerPageGetContinents
    (options: Omit<Apollo.QueryOptions<Types.GetContinentsQueryVariables>, 'query'>, ctx: ApolloClientContext ){
...
export async function getServerPageGetCountries
    (options: Omit<Apollo.QueryOptions<Types.GetCountriesQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
...
export async function getServerPageGetCountriesByCode
    (options: Omit<Apollo.QueryOptions<Types.GetCountriesByCodeQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
